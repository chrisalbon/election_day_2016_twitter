...
def start_mining():
    ...
    consumer_key = credentials['twitter']['cra_twitter_miner_13']['consumer_key']
    consumer_secret = credentials['twitter']['cra_twitter_miner_13']['consumer_secret']
    access_token = credentials['twitter']['cra_twitter_miner_13']['access_token']
    access_token_secret = credentials['twitter']['cra_twitter_miner_13']['access_secret']
