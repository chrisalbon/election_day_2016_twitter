...
def start_mining():
    ...
    consumer_key = credentials['twitter']['cra_twitter_miner_21']['consumer_key']
    consumer_secret = credentials['twitter']['cra_twitter_miner_21']['consumer_secret']
    access_token = credentials['twitter']['cra_twitter_miner_21']['access_token']
    access_token_secret = credentials['twitter']['cra_twitter_miner_21']['access_secret']
