...
def start_mining():
    ...
    consumer_key = credentials['twitter']['cra_twitter_miner_12']['consumer_key']
    consumer_secret = credentials['twitter']['cra_twitter_miner_12']['consumer_secret']
    access_token = credentials['twitter']['cra_twitter_miner_12']['access_token']
    access_token_secret = credentials['twitter']['cra_twitter_miner_12']['access_secret']
